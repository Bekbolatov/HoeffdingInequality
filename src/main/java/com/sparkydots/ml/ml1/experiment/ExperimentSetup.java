...
public class ExperimentSetup {
    ...
    public ExperimentSetup(ExperimentInput input, int num, ExperimentFactory experiments, boolean oneByOne) {
        this.input = input;
        this.num = num;
        this.experiments = experiments;
        if (oneByOne) {
            runningScore = new Score(experiments.getStatNames(), experiments.getTemplateName());
        } else {
